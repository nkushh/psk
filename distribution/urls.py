...
urlpatterns = [
	...
	path('download_facility_distribution_excel_2019_2020', views.download_facility_distribution_excel_2019_2020, name='download_facility_distribution_excel_2019_2020'),
