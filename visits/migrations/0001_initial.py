    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store_access', models.IntegerField(default=0)),
                ('pests_risk', models.IntegerField(default=0)),
                ...
                ('supervisor', models.ForeignKey(default=1, on_delete='CASCADE', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
